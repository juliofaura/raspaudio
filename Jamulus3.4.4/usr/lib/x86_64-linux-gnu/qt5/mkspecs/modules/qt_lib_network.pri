...
QT_CONFIG += networkinterface bearermanagement ftp getaddrinfo getifaddrs http ipv6ifname localserver networkdiskcache networkproxy openssl opensslv11 socks5 ssl udpsocket
QT_MODULES += network
